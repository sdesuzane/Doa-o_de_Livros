        ...
        <footer className={s.footer}>
            <section className={s.contactFooter}>
                ...
                <nav>
                    ...
                    <a href="https://www.linkedin.com/in/mariasuzane/" target="_blanck"><img src={linkedInIcon} alt="Imagem branca da logo do Linkedin" /></a>
                    <a href="https://www.instagram.com/sdesuzane/" target="_blanck"><img src={instagramIcon} alt="Imagem branca da logo do Instagram" /></a>
                </nav>
            </section>
